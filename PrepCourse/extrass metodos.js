...
let arrayy = [1,2,3,4,];
console.log(array.includes(5))    /* imprime FALSE */
// EJEMPLO 2
var pintores = ['Picasso', 'Velázquez', 'Van Gogh', 'Dalí'];
var existeDali = pintores.includes('Dalí');
console.log(existeDali);          /* imprime TRUE */
...
let objeto = {      /* y devuelve como resultado un booleano */                  
    nombre: 'matin',
    apellido: 'perez',
    edad: 21
  }
console.log(objeto.hasOwnProperty('altura')) /* aca preguntamos 
...
var palabraSeparada = palabra.split('e') 	//(esto mete un espacio entre cada "e" que tenga la palabra)
...
console.log(palabraArreglada); //Por ejemplo ['H', 'e', 'n', 'r', 'y'] lo transforma en Henry
...
// FOREACH
var numeros = [ 1, 2, 3, 4 ];
numeros.forEach( (num) => { console.log(num) } )	//(MUESTRA TODOS LOS NUM UNO POR UNO)
...
let miArrayReducido = miArray.reduce(function(acm,element){
  return acm * element         //el 1 indica que valor tendra el acm al iniciar la function
},1)                           // si el acm esta en 0 la function no respondera como 0 en la *
